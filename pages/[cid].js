...
const CID = ({ fileData }) => {
  ...
  const handleButtonClick = () => {
    ...
    router.push('https://ipfs-hash-to-blockchain.vercel.app/');
  };
  ...
  return (
      <>
        ...
        <main className="m-auto flex min-h-screen w-full flex-col items-center justify-center" style={{ background: "lightblue" }}>
          <img src={"/logoh.jpeg"} alt="Logo" style={{ width: "150px", marginBottom: "20px" }} />
            ...
            <div className="h-full max-w-screen-xl">
              <div className="m-auto flex h-full w-full items-center justify-center">
                <div className="m-auto w-3/4 text-center">
                  ...
                  <div className="mt-8 flex flex-col items-center justify-center  p-2 text-center align-center h-64 w-3/4 m-auto rounded-3xl bg-secondary px-4 py-2 text-light transition-all duration-300 ease-in-out hover:bg-accent hover:text-light">
